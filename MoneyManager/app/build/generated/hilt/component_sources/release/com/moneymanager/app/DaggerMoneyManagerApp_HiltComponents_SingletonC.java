...
public final class DaggerMoneyManagerApp_HiltComponents_SingletonC {
  ...
  private static final class ActivityCImpl extends MoneyManagerApp_HiltComponents.ActivityC {
    ...
    public Map<Class<?>, Boolean> getViewModelKeys() {
      return LazyClassKeyMap.<Boolean>of(ImmutableMap.<String, Boolean>builderWithExpectedSize(7).put(LazyClassKeyProvider.com_moneymanager_app_ui_screens_AccountsViewModel, AccountsViewModel_HiltModules.KeyModule.provide()).put(LazyClassKeyProvider.com_moneymanager_app_ui_screens_BudgetsViewModel, BudgetsViewModel_HiltModules.KeyModule.provide()).put(LazyClassKeyProvider.com_moneymanager_app_ui_screens_DashboardViewModel, DashboardViewModel_HiltModules.KeyModule.provide()).put(LazyClassKeyProvider.com_moneymanager_app_ui_screens_GoalsViewModel, GoalsViewModel_HiltModules.KeyModule.provide()).put(LazyClassKeyProvider.com_moneymanager_app_ui_screens_ReportsViewModel, ReportsViewModel_HiltModules.KeyModule.provide()).put(LazyClassKeyProvider.com_moneymanager_app_ui_screens_SettingsViewModel, SettingsViewModel_HiltModules.KeyModule.provide()).put(LazyClassKeyProvider.com_moneymanager_app_ui_screens_TransactionsViewModel, TransactionsViewModel_HiltModules.KeyModule.provide()).build());
    }
  ...
  private static final class ViewModelCImpl extends MoneyManagerApp_HiltComponents.ViewModelC {
    ...
    public Map<Class<?>, javax.inject.Provider<ViewModel>> getHiltViewModelMap() {
      return LazyClassKeyMap.<javax.inject.Provider<ViewModel>>of(ImmutableMap.<String, javax.inject.Provider<ViewModel>>builderWithExpectedSize(7).put(LazyClassKeyProvider.com_moneymanager_app_ui_screens_AccountsViewModel, ((Provider) accountsViewModelProvider)).put(LazyClassKeyProvider.com_moneymanager_app_ui_screens_BudgetsViewModel, ((Provider) budgetsViewModelProvider)).put(LazyClassKeyProvider.com_moneymanager_app_ui_screens_DashboardViewModel, ((Provider) dashboardViewModelProvider)).put(LazyClassKeyProvider.com_moneymanager_app_ui_screens_GoalsViewModel, ((Provider) goalsViewModelProvider)).put(LazyClassKeyProvider.com_moneymanager_app_ui_screens_ReportsViewModel, ((Provider) reportsViewModelProvider)).put(LazyClassKeyProvider.com_moneymanager_app_ui_screens_SettingsViewModel, ((Provider) settingsViewModelProvider)).put(LazyClassKeyProvider.com_moneymanager_app_ui_screens_TransactionsViewModel, ((Provider) transactionsViewModelProvider)).build());
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          case 2: // com.moneymanager.app.ui.screens.DashboardViewModel 
          ...
          case 3: // com.moneymanager.app.ui.screens.GoalsViewModel 
          return (T) new GoalsViewModel(singletonCImpl.goalRepositoryImplProvider.get());

          case 4: // com.moneymanager.app.ui.screens.ReportsViewModel 
          ...
          case 5: // com.moneymanager.app.ui.screens.SettingsViewModel 
          ...
          case 6: // com.moneymanager.app.ui.screens.TransactionsViewModel 
          return (T) new TransactionsViewModel(singletonCImpl.transactionRepositoryImplProvider.get());
