  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(@NonNull final SupportSQLiteDatabase db) {
        ...
        db.execSQL("CREATE INDEX IF NOT EXISTS `index_transactions_tagIds` ON `transactions` (`tagIds`)");
        ...
        db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, 'ece5efb729dc626479080509afb35839')");
      }
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        _indicesTransactions.add(new TableInfo.Index("index_transactions_note", false, Arrays.asList("note"), Arrays.asList("ASC")));
        _indicesTransactions.add(new TableInfo.Index("index_transactions_tagIds", false, Arrays.asList("tagIds"), Arrays.asList("ASC")));
    ...
    }, "ece5efb729dc626479080509afb35839", "6ed38a5cbae4df0d13660ac4b8e3c991");
