...
class PeerContactRepositoryImpl @Inject constructor(
    ...
    override suspend fun getPeerByName(name: String): PeerContact? =
        peerContactDao.getPeerByName(name)

    override fun getTotalOutstanding(): Flow<Double?> =
        peerContactDao.getTotalOutstanding()
    ...
    override suspend fun deletePeerById(id: Long) =
        peerContactDao.deletePeerById(id)
}