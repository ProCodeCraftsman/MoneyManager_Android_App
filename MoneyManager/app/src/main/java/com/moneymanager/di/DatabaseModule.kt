...
object DatabaseModule {
    ...
    fun provideDatabase(@ApplicationContext context: Context): MoneyManagerDatabase {
        return Room.databaseBuilder(
            ...
            .addMigrations(MIGRATION_2_3, MIGRATION_5_6, MIGRATION_6_7, MIGRATION_7_8, MIGRATION_8_9, MIGRATION_9_10, MIGRATION_10_11, MIGRATION_11_12, MIGRATION_12_13, MIGRATION_13_14, MIGRATION_14_15)
